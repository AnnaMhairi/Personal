...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${inter.variable} ${instrument.variable} scroll-smooth`}>
      <body>
        <div className="container mx-auto px-6 md:px-10 lg:px-14 py-10 md:py-14">
          {/* two columns from md up */}
          <div className="grid gap-rhythm md:grid-cols-[var(--col-rail)_minmax(0,1fr)]">
            {/* left rail (sticky like ref) */}
            <aside className="rail md:sticky md:top-[var(--rail-top)] md:h-[calc(100vh-var(--rail-top)-1rem)]">
